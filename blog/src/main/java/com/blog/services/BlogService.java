...
public class BlogService {
	...
	// そうでない場合
	// false
	public boolean createBlog(String title, String content, String image, Long account) {
	...
	// trueを返す
	public boolean blogUpdate(Long blogId, String title, String content, String image, Long accountId) {
		if (blogId == null) {
			return false;
		} else {
			Optional<Blog> blogOptional = blogDao.findById(blogId);
